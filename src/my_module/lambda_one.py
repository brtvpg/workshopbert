...
def lambda_handler(event, context):
    ...
    xray_subsegment.put_annotation('application', 'workshopbert')
    xray_subsegment.put_metadata('event', event, 'workshopbert')
    ...
    try:
        ...
        subsegment.put_metadata('message', message, 'workshopbert')
